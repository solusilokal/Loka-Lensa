    ...
    <>
      ...
      <main className="w-full max-w-[480px] mx-auto relative shadow-2xl bg-slate-50 min-h-screen overflow-hidden pb-32">
        ...
        <section className="relative w-full min-h-[90dvh] flex flex-col justify-end pb-10 px-6 bg-slate-900">
          ...
          <div className="relative z-10 flex flex-col items-center text-center mt-32">
            ...
            <button 
              ...
              className="group relative flex items-center justify-center gap-3 w-full max-w-sm py-4 bg-[#ca8a04] text-white rounded-2xl font-bold text-sm uppercase tracking-wider hover:bg-[#a16207] transition-all shadow-[0_8px_20px_rgba(202,138,4,0.3)] border border-[#facc15]/20"
            >
              <Camera size={18} />
              Sewa Sekarang
        ...
        <section id="booking-form" className="py-14 px-6 bg-slate-100">
          <div className="bg-white border border-slate-200 rounded-[2rem] p-6 sm:p-8 shadow-xl relative overflow-hidden">
            ...
            <form onSubmit={handleFormSubmit} className="flex flex-col gap-4 relative z-10">
              ...
              <button 
                type="submit"
                className="w-full mt-2 bg-[#25D366] text-white font-bold text-sm tracking-wide py-4 rounded-xl flex items-center justify-center gap-2 hover:bg-[#1EBE5A] transition-colors shadow-md"
              >
                Kirim via WhatsApp
        ...
        >
          <button 
            onClick={scrollToForm}
            className="w-full flex items-center justify-between px-6 py-4 bg-[#0f172a] backdrop-blur-xl border border-[#ca8a04]/50 rounded-2xl text-white shadow-[0_10px_40px_rgba(15,23,42,0.4)] hover:bg-slate-900 active:scale-[0.98] transition-all"
          >
